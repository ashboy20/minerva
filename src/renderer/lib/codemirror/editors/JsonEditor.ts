...
import {
	...
	variableHover,
	variableDecorations,
} from '@/renderer/lib/codemirror/extensions/VariableExtensions';
import {
	BaseEditor,
	BaseEditorOptions,
	BaseEditorInstance,
...
export function useJsonEditor(
	...
	const editorInstanceRef =
		React.useRef<JsonEditorInstance | null>(null);
	...
	React.useEffect(() => {
		if (
			...
			editorInstanceRef.current = createJsonEditor(
				containerRef.current,
				editorOptions,
			);
		}
